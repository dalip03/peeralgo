...
export const mentors: MentorType[] = [
  {
    ...
    tags: ["Java", "System Design", "NodeJS" , "React", "AWS" , "Docker", "Kubernetes",   "Microservices", "Agile", "CI/CD"],
    skills: ["Leadership & Communication", "System Design", "Java"],
    tools: ["Postman", "VS Code", "Docker", "GitHub"],
    description: "As an experienced college senior engineering manager, I possess a wealth of knowledge crucial for guiding aspiring managers and engineers. Establishing a mentorship program designed to im",
  ...
  },
  {
    ...
    languages: ["English"],
    tags: ["Apex", "Salesforce", "Cloud", "APIs", "DevOps", "Microservices",  "CI/CD", "Agile", "Docker", "Kubernetes", "GitHub", "Jenkins"],
