            ...
            return (
              <div key={mentor.id} className="bg-white rounded-xl shadow flex flex-col md:flex-row p-6 mb-6 gap-6">
                ...
                <div className="flex flex-col justify-center items-center gap-2 min-w-[180px]">
                  <ul className="text-xs text-gray-500 mb-2 space-y-2">
                    <li>
                      <FaBook className="inline-block mr-1" />
                  ...
                  <span className="bg-blue-100 text-blue-700 text-xs font-semibold rounded-full px-3 py-1 mb-1">
                    {mentor.discount}
                  </span>
                  <button
                  ...
                  <button className="w-full py-2 px-2 rounded-md bg-blue-500 text-white font-semibold shadow hover:bg-blue-600 transition">
                    Book a Free Trial
                  </button>
                </div>
              </div>
