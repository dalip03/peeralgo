...
export default function WhyChooseUs() {
  return (
    <section 
      className="w-full pt-10 pb-20 px-4 transition-colors duration-300"
      style={{
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          >
            <div className="md:inline-block mb-5 text-center md:text-left">
              <span 
                className="text-xs font-semibold rounded-full px-4 py-1 shadow-sm select-none transition-colors duration-300"
                style={{
                  background: "var(--why-badge-bg, #ffffff)",
                  border: "1px solid var(--why-badge-border, #d1d5db)",
                  color: "var(--why-badge-text, #374151)"
                }}
              >
                Our Solutions
              </span>
            ...
            <motion.h2
              className="text-2xl md:text-3xl font-bold md:text-left text-center mb-2"
          ...
          >
            <p 
              className="md:text-right text-[15px] md:max-w-sm"
              style={{ color: "var(--why-text, #4b5563)" }}
            >
